...
LATENCY_FILE = "latency_20251018_103050.jsonl"
MISSION_FILE = "last_mission.json"
...
def load_waypoints(filepath):
    """Parse mission file for waypoints."""
    with open(filepath, "r") as f:
        data = json.load(f)
    ...
    if "missions" in data:
        ...
        waypoints = [np.array(wp["coords"]) for wp in data["waypoints"]]
